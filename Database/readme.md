...
`docker run --cap-add SYS_PTRACE -e 'ACCEPT_EULA=1' -e 'MSSQL_SA_PASSWORD=yourStrong(!)Password' -p 56028:1433 --name FeatherTracker-database -d mcr.microsoft.com/azure-sql-edge`

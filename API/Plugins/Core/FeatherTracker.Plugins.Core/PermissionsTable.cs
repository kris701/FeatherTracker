namespace FeatherTracker.Plugins.Core
{
	public static class PermissionsTable
	{
		...
		public const string Core_Users_Own_Read = "core.users.own.read";
		public const string Core_Users_Own_Write = "core.users.own.write";
